...
Shader "arktoon/mod/FadeRefractedScrolled" {
    Properties {
        // Double Sided
        ...
        // Scroll
        _UScroll ("[Scroll] U Scroll", Range(-10,10)) = 0
        _VScroll ("[Scroll] V Scroll", Range(-10,10)) = 0
        _UScrollEmission ("[Scroll] U Scroll Emission", Range(-10,10)) = 0
        _VScrollEmission ("[Scroll] V Scroll Emission", Range(-10,10)) = 0
        // Common
    ...
    FallBack "Standard"
    CustomEditor "ArktoonShadersMod.ArktoonInspectorMod"
}

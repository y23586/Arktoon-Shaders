...
namespace ArktoonShadersMod
{
    public class ArktoonInspectorMod : ShaderGUI
    {
        ...
        MaterialProperty UScroll;
        MaterialProperty VScroll;
        MaterialProperty UScrollEmission;
        MaterialProperty VScrollEmission;
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
        {
            ...
            if(isRefracted) UScroll = FindProperty("_UScroll", props);
            if(isRefracted) VScroll = FindProperty("_VScroll", props);
            if(isRefracted) UScrollEmission = FindProperty("_UScrollEmission", props);
            if(isRefracted) VScrollEmission = FindProperty("_VScrollEmission", props);
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                // Scroll
                if(isRefracted){
                    UIHelper.ShurikenHeader("Scrolling");
                    {
                        EditorGUI.indentLevel ++;
                        materialEditor.ShaderProperty(UScroll, "Base:UScroll");
                        materialEditor.ShaderProperty(VScroll, "Base:VScroll");
                        materialEditor.ShaderProperty(UScrollEmission, "Emission:UScroll");
                        materialEditor.ShaderProperty(VScrollEmission, "Emission:VScroll");
                        EditorGUI.indentLevel --;
                    }
                }
